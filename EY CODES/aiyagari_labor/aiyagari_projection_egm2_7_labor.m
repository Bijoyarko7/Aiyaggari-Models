function [f1,aggk,aggn,v2,optk2,optc2,opth2] = aiyagari_projection_egm2_7_labor(r,alpha,beta,delta,theta,zgrid,piz,kgrid,f1,v2,optk2,optc2,opth2,hot)

w = (1-alpha)*(r/alpha)^(alpha/(alpha-1));

if hot == 0
    v2 = zeros(51,7); optk2 = zeros(151,7); optc2 = zeros(151,7); opth2 = zeros(151,7);
    for i=1:7
